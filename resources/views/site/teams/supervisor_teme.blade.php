                    ...
                    @foreach ($teams as $row)
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @php
                                        $students = App\Models\Team_Member::whereHas('team')
                                            ->whereHas('student')
                                            ->where('team_id', $row->id)
                                            ->get();
                                        $auth_id = App\Models\Team_Member::whereHas('student')
                                    ...
                                    @endforeach
                                    @if (!$auth_id && $row->stuednt_count != 0)
                                        <a href="{{ route('site.team.supervisor.join', $row->id) }}"
