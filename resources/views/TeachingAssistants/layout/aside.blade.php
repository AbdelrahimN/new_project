<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-2 bg-slate-900 fixed-start">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-wieht" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active" href="{{ route('teachingAssistant.dashboard') }}">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('TeachingAssistants.student.team.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Student Team</span>
                </a>
            </li>
        </ul>
    </div>
