<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-2 bg-slate-900 fixed-start">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-wieht" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  active" href="{{ route('supervisor.dashboard') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center $blue-600
">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('supervisor.TeachingAssistants.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('supervisor.teams.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fill="none" d="M0 0h24v24H0z"/>
                            <path d="M10 8a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0-2a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm8 6a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0-2a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm-8 6a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm0-2a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/>
                        </svg>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('supervisor.projects.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path fill="none" d="M0 0h24v24H0z"/>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('supervisor.applys.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shield">
                            <path d="M12 2v10m0 0L2 14l4-4m4 4l4 4 6-6m-6 6v6H6v-6m12 0H6"/>
                        </svg>
                    </div>
                    <span class="nav-link-text ms-1">Applys</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('supervisor.projects.requests.index') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shield">
                            <path d="M12 2v10m0 0L2 14l4-4m4 4l4 4 6-6m-6 6v6H6v-6m12 0H6"/>
                        </svg>
                    </div>
                    <span class="nav-link-text ms-1">ProjectRequests</span>
                </a>
            </li>
        </ul>
    </div>
